...
DiscordServerParagraph = Tabs.InfoTab:Paragraph({
    ...
    Desc = "Link Discord RTaO!",
    TextXAlignment = "Left",
    Buttons = {{
        Title = "Copy Link Discord",
        Callback = function()
            setclipboard("https://dsc.gg/EH23mXVqce");
            WindUI:Notify({
                Title = "Notication",
...
DiscordServerParagraph1 = Tabs.InfoTab:Paragraph({
    Title = "Social RTaO Dev",
    Desc = "Link Social RTaO Dev!",
    TextXAlignment = "Left",
    Buttons = {{
        Title = "Copy Social RTaO Dev",
        Callback = function()
            setclipboard("https://guns.lol/rtao_dev");
            WindUI:Notify({
                Title = "Notication",
...
local WebhookURL =
    "https://discord.com/api/webhooks/1410824987006337125/sU5EvsFhU9d_DVEnWz77d4TN68Mzo2DFb7aals_wfvyfeCHxgssRTVCh8n2YQdqx0dke"
